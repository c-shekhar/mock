...
# Local imports...
from project.services import TodoManager

@patch('project.services.TodoManager.get_todos')
def test_getting_uncompleted_todos_when_todos_is_not_none(mock_get_todos):
    ...
    uncompleted_todos = tdm.get_uncompleted_todos()
...
#     @classmethod
#     def setup_class(cls):
#         cls.mock_get_todos_patcher = patch('project.services.TodoManager.get_todos')
